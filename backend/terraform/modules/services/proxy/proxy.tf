...
resource "aws_appautoscaling_target" "proxy_autoscaling_target" {
  max_capacity       = 10
  min_capacity       = 1
...
resource "aws_appautoscaling_policy" "proxy_autoscaling_policy" {
  name               = "proxy-autoscaling-policy"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.proxy_autoscaling_target.resource_id
  scalable_dimension = aws_appautoscaling_target.proxy_autoscaling_target.scalable_dimension
  service_namespace  = aws_appautoscaling_target.proxy_autoscaling_target.service_namespace
