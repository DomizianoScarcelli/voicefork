...
resource "aws_appautoscaling_policy" "reservations_autoscaling_policy" {
  name               = "reservations-autoscaling-policy"
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.reservations_autoscaling_target.resource_id
  scalable_dimension = aws_appautoscaling_target.reservations_autoscaling_target.scalable_dimension
  service_namespace  = aws_appautoscaling_target.reservations_autoscaling_target.service_namespace
