...
class MinioServiceUsers {
    ...
    constructor() {
        ...
        if (process.env.USE_MINIO_LOCAL) {
            if (
                process.env.MINIO_USERS_ACCESS_KEY == undefined ||
                process.env.MINIO_USERS_SECRET_KEY == undefined
            )
            ...
            this.client = new Minio.Client({
                ...
                port: 9001,
                accessKey: process.env.MINIO_USERS_ACCESS_KEY,
                secretKey: process.env.MINIO_USERS_SECRET_KEY,
                useSSL: false,
            })
...
export default MinioServiceUsers